...
-- 10 rows for each main table

-- Enable extension required for password hashing
...
-- 1. GYMS  
INSERT INTO gyms (gym_name, address, city)
VALUES 
('FitHub', '123 Main Street', 'Bangkok');
...
VALUES
-- Today classes
(1, 1, 'Morning Yoga',    CURRENT_DATE, '07:00', '08:00', 15, 'Relaxing morning yoga.', 'scheduled', NOW()),
(1, 2, 'HIIT Training',   CURRENT_DATE, '18:00', '19:00', 20, 'High intensity HIIT.',   'scheduled', NOW()),
(1, 3, 'Pilates',         CURRENT_DATE, '09:00', '10:00', 12, 'Core pilates class.',    'scheduled', NOW()),
(1, 4, 'Boxing Basics',   CURRENT_DATE, '17:00', '18:00', 10, 'Beginner boxing.',       'scheduled', NOW()),
-- Future classes
(1, 5, 'Zumba Dance',     CURRENT_DATE + INTERVAL '1 day', '19:00', '20:00', 20, 'Energetic dance workout.', 'scheduled', NOW()),
(1, 6, 'Strength Training',CURRENT_DATE + INTERVAL '2 days','18:00','19:00', 18, 'Full body strength.',       'scheduled', NOW()),
-- Past classes
(1, 1, 'Sunrise Yoga',    CURRENT_DATE - INTERVAL '1 day', '06:30', '07:30', 15, 'Early morning yoga.', 'completed', NOW()),
(1, 2, 'Cardio Blast',    CURRENT_DATE - INTERVAL '2 days','17:00','18:00', 20, 'Cardio focused.',     'completed', NOW()),
(1, 3, 'Pilates Basics',  CURRENT_DATE - INTERVAL '3 days','09:00','10:00', 12, 'Intro pilates.',     'completed', NOW()),
(1, 4, 'Kickboxing',      CURRENT_DATE - INTERVAL '4 days','18:00','19:00', 16, 'Kickboxing workout.', 'completed', NOW());
...
VALUES
-- Paid this month
(1,  49.00,  date_trunc('month', CURRENT_DATE)::DATE + 0,  date_trunc('month', CURRENT_DATE)::DATE + 1,  'paid',    'card', NOW()),
(2,  49.00,  date_trunc('month', CURRENT_DATE)::DATE + 5,  date_trunc('month', CURRENT_DATE)::DATE + 5,  'paid',    'cash', NOW()),
(3, 135.00,  date_trunc('month', CURRENT_DATE)::DATE + 10, date_trunc('month', CURRENT_DATE)::DATE + 9,  'paid',    'transfer', NOW()),
-- Paid last month
(4,  49.00,  (date_trunc('month', CURRENT_DATE) - INTERVAL '15 days')::DATE, 
              (date_trunc('month', CURRENT_DATE) - INTERVAL '10 days')::DATE, 'paid', 'card', NOW()),
(5, 400.00,  (date_trunc('month', CURRENT_DATE) - INTERVAL '20 days')::DATE, 
              (date_trunc('month', CURRENT_DATE) - INTERVAL '18 days')::DATE, 'paid', 'card', NOW()),
-- Pending this month (not overdue yet)
(6,  49.00,  date_trunc('month', CURRENT_DATE)::DATE + 15,  NULL, 'pending', NULL, NOW()),
(7,  49.00,  date_trunc('month', CURRENT_DATE)::DATE + 18,  NULL, 'pending', NULL, NOW()),
-- Overdue (pending, due before this month)
(8,  49.00,  (date_trunc('month', CURRENT_DATE) - INTERVAL '5 days')::DATE,   NULL, 'pending', NULL, NOW()),
(9, 135.00,  (date_trunc('month', CURRENT_DATE) - INTERVAL '20 days')::DATE,  NULL, 'pending', NULL, NOW()),
(10,49.00,   (date_trunc('month', CURRENT_DATE) - INTERVAL '40 days')::DATE,  NULL, 'pending', NULL, NOW());
